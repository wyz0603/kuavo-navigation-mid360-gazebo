...
- 示例代码位于：`/home/lab/kuavo-ros-opensource/src/demo/taiji/action_player`
...
4. H12遥控器执行全身打太极动作案例
 ...
 - 修改下位机路径为 `/home/lab/kuavo-ros-opensource/src/humanoid-control/h12pro_controller_node/config/customize_config.json` 配置文件。
 - 填入您想使用的遥控器按键组合，例如:
  ```bash
