...
class SimulatedJoystick:
    ...
    def update_joy(self, key):
        ...
        if key == 'w':
            ...
            self.joy_msg.buttons[BUTTON_X] = 1  # 发送RL
        elif key == 'c':
            ...
            self.joy_msg.buttons[BUTTON_LB] = 1  # 发送BUTTON_LB
    ...
    def run(self):
        try:
            ...
            print("R: RL, C: stance, T: trot")
            print("B: BUTTON_BACK, O/F: BUTTON_START, P: walkenable")
