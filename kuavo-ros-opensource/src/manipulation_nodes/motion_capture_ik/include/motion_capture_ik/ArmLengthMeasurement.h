...
public:
  ArmLengthMeasurement()
      : measureArmLength_(false), avgLeftUpperArmLength_(0.0),
        avgLeftLowerArmLength_(0.0), avgRightUpperArmLength_(0.0),
        avgRightLowerArmLength_(0.0) {}

  void setMeasureArmLength(bool measureArmLength) {
    measureArmLength_ = measureArmLength;
  }
